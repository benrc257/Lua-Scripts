These scripts were created in Lua for programming a set of robots in a modded version of Minecraft (ComputerCraft: Retweaked). Each script serves a different function.
